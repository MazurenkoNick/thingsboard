...
public class EntityViewEdgeTest extends AbstractEdgeTest {
    ...
    @Test
    public void testSendUnassignEntityViewFromGroupOnEdgeToCloud() throws Exception {
        Device device = saveDeviceOnCloudAndVerifyDeliveryToEdge();
    ...
    public void testSendDeleteEntityViewOnEdgeToCloud() throws Exception {
        ...
        await().atMost(30, TimeUnit.SECONDS).untilAsserted(() ->
                doGet("/api/entityView/info/" + entityViewOnCloud.getUuidId(), EntityViewInfo.class, status().isNotFound())
        );
    }
