...
public interface AgentBulkOperationService {
    ...
    BulkOperationResult bulkOperation(TenantId tenantId, AgentGroupId groupId, AgentAppProfileId profileId, BulkOperationRequest request, boolean force, User user);
}
