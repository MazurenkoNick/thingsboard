...
CREATE INDEX IF NOT EXISTS idx_agent_application_agent_id ON agent_application(agent_id);
...
CREATE INDEX IF NOT EXISTS idx_agent_bulk_action_status ON agent_bulk_action(status);
