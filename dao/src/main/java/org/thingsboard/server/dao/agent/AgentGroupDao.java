...
public interface AgentGroupDao extends Dao<AgentGroup> {

    AgentGroupInfo findAgentGroupInfoById(UUID groupId);

    PageData<AgentGroup> findByTenantId(UUID tenantId, PageLink pageLink);
