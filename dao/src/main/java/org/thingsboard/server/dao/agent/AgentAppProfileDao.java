...
public interface AgentAppProfileDao extends Dao<AgentAppProfile> {
    ...
    List<AgentAppProfileRelationInfo> findRelationInfosByAgentProfileIdAndAppTypeAndTemplateId(UUID agentProfileId, AgentApplicationType appType, UUID templateId, String relationType);

    Long countByTenantId(TenantId tenantId);

    List<AgentAppProfile> findUninstalledAppProfilesForAgentProfile(UUID agentProfileId, UUID agentId);
}
