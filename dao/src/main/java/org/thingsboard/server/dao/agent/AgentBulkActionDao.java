...
public interface AgentBulkActionDao extends Dao<AgentBulkAction> {
    ...
    PageData<AgentBulkAction> findByAgentProfileId(AgentProfileId profileId, PageLink pageLink);

    PageData<AgentBulkAction> findByAgentProfileIdAndApplicationProfileId(AgentProfileId profileId,
