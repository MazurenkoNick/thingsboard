...
import { TrendzSummary, TrendzSynchronization } from '@app/shared/models/trendz-analytics.models';
...
export class TrendzService {
  ...
  public getTrendzSyncStatus(config?: RequestConfig): Observable<TrendzSynchronization> {
