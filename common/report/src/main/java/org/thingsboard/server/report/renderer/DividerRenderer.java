...
@Component
public class DividerRenderer implements PdfReportComponentRenderer<DividerComponent> {

    @Override
    public String render(DividerComponent component, ComponentData reportDataSource) {
