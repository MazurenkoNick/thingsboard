...
public class AgentApplicationId extends UUIDBased implements EntityId {
    ...
    @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "string", example = "AGENT_APPLICATION", allowableValues = "AGENT_APPLICATION")
    @Override
    public EntityType getEntityType() {
        return EntityType.AGENT_APPLICATION;
    }

    public static AgentApplicationId fromMsgAndLsb(long msg, long lsb) {
        return new AgentApplicationId(new UUID(msg, lsb));
    }
}
