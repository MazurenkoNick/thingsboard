...
public class AgentAppUnitId extends UUIDBased implements EntityId {
    ...
    @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "string", example = "AGENT_APP_UNIT", allowableValues = "AGENT_APP_UNIT")
    @Override
    public EntityType getEntityType() {
        return EntityType.AGENT_APP_UNIT;
    }

    public static AgentAppUnitId fromMsgAndLsb(long msg, long lsb) {
        return new AgentAppUnitId(new UUID(msg, lsb));
    }
}
