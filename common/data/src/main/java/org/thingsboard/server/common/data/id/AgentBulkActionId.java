...
public class AgentBulkActionId extends UUIDBased implements EntityId {
    ...
    @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "string", example = "AGENT_BULK_ACTION", allowableValues = "AGENT_BULK_ACTION")
    @Override
    public EntityType getEntityType() {
        return EntityType.AGENT_BULK_ACTION;
    }

    public static AgentBulkActionId fromMsgAndLsb(long msg, long lsb) {
        return new AgentBulkActionId(new UUID(msg, lsb));
    }
}
