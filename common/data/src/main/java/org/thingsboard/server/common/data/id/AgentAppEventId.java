...
public class AgentAppEventId extends UUIDBased implements EntityId {
    ...
    @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "string", example = "AGENT_APP_EVENT", allowableValues = "AGENT_APP_EVENT")
    @Override
    public EntityType getEntityType() {
        return EntityType.AGENT_APP_EVENT;
    }

    public static AgentAppEventId fromMsgAndLsb(long msg, long lsb) {
        return new AgentAppEventId(new UUID(msg, lsb));
    }
}
