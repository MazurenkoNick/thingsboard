...
public interface AgentAppProfileService extends EntityDaoService {
    ...
    List<AgentAppProfileRelationInfo> findProfileRelationInfosByAgentProfileIdAndAppTypeAndTemplateId(
            TenantId tenantId, AgentProfileId agentProfileId, AgentApplicationType appType, AgentAppTemplateId templateId);
