...
public interface SchedulerEventService extends EntityDaoService {
    ...
    PageData<ScheduledReportInfo> findSchedulerReportEvents(TenantId tenantId, ScheduledReportQuery query);

    PageData<ScheduledReportInfo> findSchedulerReportEvents(TenantId tenantId, CustomerId customerId, ScheduledReportQuery query);
}
